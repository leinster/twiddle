...
*** Formatting
Use [[https://github.com/easy-coding-standard/easy-coding-standard][ECS]], [[file:ecs.php::<?php][configuration]]:
...
Use ~--fix~ to fix the code:

#+begin_example
$ composer lint:fix
#+end_$ vendor/bin/ecs --fix
#+end_example

*** Rector

[[file:rector.php::<?php][Configuration]].
